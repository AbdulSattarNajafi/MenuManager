...
//Left lists Links
$('#uon_section_offers #list-group .list-group-item').unbind('click').click(function(e) {
  e.stopPropagation();
  
  $('#uon_section_offers #list-group .list-group-item').removeClass('selected');
  $('#uon_section_offers #list-group .list-group-item').addClass('disselect');
